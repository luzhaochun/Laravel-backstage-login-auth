...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type="text/javascript" src="{{ URL::asset('/js/backstage/push/useradd.js')}}"></script>
    ...
    <body>
        <div style="margin-top: 30px;margin-left: 30px;">
            <form id="addStaff" class="formbody" action="{{url('/Pushuser/add')}}" method="post">
                <ul class="forminfo uew-select">
                    <li>
                        <span>真实姓名</span>
                        <input id='name' name="name" class="dfinput" value="" placeholder="真实姓名"/>
                         <label id="name-error" class="error" for="name"></label>
                    </li>
                    <li>
                        <span>登陆ID</span>
                        <input id="login_id" name="login_id" class="dfinput" value="" placeholder="登陆ID"/>
                    ...
                    <li>
                        <span>手机号码</span>
                        <input name="phone" id="phone" type="text" class="dfinput" value="" placeholder="手机号码"/>
                        <label id="phone-error" class="error" for="phone"></label>
                        
                    </li>
                    <li>
                        <span>生日</span>
                        <input name="birthday" id="apply_start_time" value="" type="text" class="date scinput"></input>
                    </li>
                    <li>
                        <span>性别</span>                     
                        <cite>
                            <input type="radio" name="sexuality" value="1" checked="checked"> 男</input>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="radio" name="sexuality" value="2"> 女</input>
                        </cite>
                    </li>
                    <li>
                        <span>是否活动</span>
                        <cite>
                            <input type="radio" name="is_active" value="1" checked="checked"> 正常</input>&nbsp;&nbsp;&nbsp;
                            <input type="radio" name="is_active" value="0"> 冻结</input>
                        </cite>
