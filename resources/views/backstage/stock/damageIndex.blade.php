...
<head>
    ...
    <script type="text/javascript" src="/js/backstage/stock/damage/damagelist.js"></script>
</head>
<body>
<div class="place">
    <span>位置：</span>
    <ul class="placeul">
        ...
        <li><a href="/StockManage/damageIndex">库存管理</a></li>
        <li>报损管理</li>
    </ul>
</div>
...
<div class="rightinfo">
    <div class="tools">
        <form method="get" action="{{ url('/StockManage/damageIndex') }}" name="frm_search" id="frm_search">
            <ul class="toolbar">
                <label>搜索：产品名称/产品编号/货架编号/操作人姓名 </label>
        ...
        <ul class="toolbar1" style="cursor:pointer">
            <li id="add_damage" class="add_damage" ><span><img src="/images/t01.png" /></span>新增</li>
        </ul>
    </div>
    ...
    <table class="tablelist">
        ...
        if(!empty($items)){ 
            ...
            <tr>
                ...
                <td><?=$item->shelf_no?></td>
                <td><?=$item->remark?></td>
                <td><?=$item->operater_name?></td>
                <td><?=$item->operate_date?></td>
                <td><a href="#" class="tablelink edit_damage" id="edit_damage" data-id="<?php echo $item->id ?>">编辑</a>
                    <a href="#" class="tablelink damageDel" data-id="<?php echo $item->id ?>">删除</a></td>
            </tr>
        <?php } }else{ ?>
